...
public class Ex1 {
    public static void main(String[] args) throws ClassNotFoundException, NoSuchFieldException, NoSuchMethodException {
        Class employeeClass = Class.forName("Tregulov.reflection.Employee");
...
//        Class employeeClass3 = emp.getClass();
        ...
        System.out.println("Return type = " + someMethod1.getReturnType() + ", parameter types = " +
                Arrays.toString(someMethod1.getParameterTypes()));

        System.out.println("********************************");

        Method someMethod2 = employeeClass.getMethod("setSalary", double.class);
        System.out.println("Return type setSalary = " + someMethod2.getReturnType() + ", parameter types = " +
